    ...
    return (
        <div className={`${satoshi.className} bg-white flex justify-center relative`}>
            ...
            <div className="flex flex-col space-y-18 my-18 min-[500px]:my-24">
                <h1 className="text-3xl min-[450px]:text-4xl min-[750px]:text-5xl text-black font-bold self-center">Highlighted Experience</h1>
                <div className="grid grid-cols-1 min-[500px]:grid-cols-2 gap-y-8 gap-x-2 min-[550px]:gap-y-12 min-[550px]:gap-x-12 min-[850px]:flex min-[850px]:justify-around min-[850px]:space-x-2 min-[1000px]:space-x-12 min-[1250px]:space-x-24">
